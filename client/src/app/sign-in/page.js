...
export default function LoginPage() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-zinc-50 p-4 dark:bg-black">
      <Card className="w-full max-w-md border-zinc-200 shadow-sm dark:border-zinc-800 dark:bg-zinc-950">
        {/* --- Header / Logo --- */}
        ...
        {/* --- Footer --- */}
        <CardFooter className="flex flex-col gap-2 border-t border-zinc-100 bg-zinc-50/50 p-6 dark:border-zinc-800 dark:bg-zinc-900/50">
