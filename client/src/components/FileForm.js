...
export default function FileForm({ token }) {
  ...
  const handleDelete = async (fileId) => {
    if (
      !confirm(
        "Are you sure? This will delete the file and all its knowledge chunks."
      )
    )
      return;
  ...
  const handleSubmit = async (e) => {
    ...
    // Ensure backend expects "file_uploads" or change this string to match your API
    ...
    try {
      ...
      if (res.ok) {
        ...
        // Clear the actual input DOM element
